        ...
        <>
            <div className="relative">
                ...
                <div className='h-10 flex gap-2 '>
                    <input onChange={(e) => setNewComment(e.target.value)} value={newComment} type="text" id="commentInput" className="block w-full h-full p-4 ps-10 text-sm text-gray-900 border rounded-full border-blue-500  bg-gray-50 focus:ring-blue-500 focus:border-blue-500  " placeholder="Comment..." required />
